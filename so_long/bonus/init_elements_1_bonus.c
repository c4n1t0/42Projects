...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   init_elements_1_bonus.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: jaromero <jaromero@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/08/29 13:12:55 by jaromero          #+#    #+#             */
/*   Updated: 2022/09/04 22:18:44 by jaromero         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	game->i_count = mlx_put_string(game->mlx, "Contador movimientos:", 5, 5);
	game->str = ft_itoa(game->counter);
	game->i_count1 = mlx_put_string(game->mlx, game->str, 250, 5);
	free(game->str);
}
